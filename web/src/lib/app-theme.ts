...
const controlTheme = {
    light: {
        solidBg: "#171717",
        // 保留本地浅色模式的可见 hover/active 反馈，避免近黑主按钮继续加深后无变化。
        solidHoverBg: "#404040",
    ...
    dark: {
        ...
        controlFocus: "rgba(255, 255, 255, 0.22)",
        switchOffBg: "rgba(255, 255, 255, 0.16)",
        switchOffHoverBg: "rgba(255, 255, 255, 0.24)",
        switchOffHandle: "#fafafa",
        menuBg: "#262626",
        menuText: "#fafafa",

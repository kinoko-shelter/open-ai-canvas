...
const TeamCreditManagementPage = lazy(() => import("@/pages/admin/admin-route-pages").then((module) => ({ default: module.TeamCreditManagementPage })));
        ...
        children: [
            ...
            { path: "/canvas/:id", element: <RequireAuth>{deferred(<CanvasProjectPage />)}</RequireAuth> },
            {
                ...
                children: [
                    ...
                    { path: "team-credit-management", element: deferred(<TeamCreditManagementPage />) },

    ...
    return (
        <main className="h-dvh min-h-0 overflow-y-auto bg-[#08090c] text-white lg:overflow-hidden">
            <div className="grid min-h-full lg:h-full lg:grid-cols-[minmax(0,1.32fr)_minmax(520px,1fr)]">
                <section className="relative min-h-[250px] overflow-hidden sm:min-h-[320px] lg:min-h-0" aria-label="故事创作品牌影片">
                    <video
                    ...
                    >
                        <p className="text-xs font-semibold tracking-[0.18em] text-white/58">STORY STUDIO</p>

...
import { FolderPlus, LayoutGrid, List, Plus, RefreshCw, Search } from "lucide-react";
...
export default function TasksPage() {
    ...
    const renderTaskRow = (task: GenerationTask) => (
        <TaskListRow
            ...
            actingId={actingId}
			canCollect={canCollectGenerationTask(task) && !isGenerationTaskMediaCollected(task, assets)}
			onCollect={() => void collectTaskMedia(task)}

    ...
    return (
        <header className="app-workspace-topbar flex shrink-0 items-center justify-between gap-3 px-4 sm:px-5">
            <div className="flex min-w-0 items-center gap-2">
                ...
                <Link to="/" className="app-workspace-brand-link inline-flex min-w-0 items-center gap-2 text-foreground" title="故事创作工作台">
                    ...
                    <span className="app-workspace-brand-wordmark truncate text-[var(--fs-body)] font-semibold">故事创作</span>
                </Link>
            </div>

                ...
                <Popover
                    ...
                    content={(
                        <div className="w-[232px] py-0.5">
                            ...
                            <button type="button" className="flex h-9 w-full items-center gap-2 rounded px-2 text-xs text-foreground/55 hover:bg-surface-hover hover:text-foreground" onClick={() => { setMenuOpen(false); setPasswordOpen(true); }}><KeyRound className="size-3.5" />修改密码</button>

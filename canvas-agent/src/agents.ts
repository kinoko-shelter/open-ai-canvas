...
class CodexAppClient {
    ...
    static async start(emit: AgentEmit) {
        ...
        await client.request("initialize", { clientInfo: { name: "canvas-agent", title: "故事创作 Canvas Agent", version: VERSION }, capabilities: { experimentalApi: true, requestAttestation: false } });
